// React Native Screen: Ongoing Gas Order Details (NO map used)
...
//           <Text style={styles.subtitle}>Your gas cylinder is on the way</Text>
//         </View>
//       </View>
...
//       <Icon name="local-gas-station" size={40} color={COLORS.primary} />
//       <View>
...
export default function OngoingOrderDetails({navigation}) {
  ...
  // null = no ongoing order
  // Example: setOngoingOrder({ id: "4521", ... }) when order exists
