...
const styles = StyleSheet.create({
  ...
  emptyText: { fontSize: fontSize.md, color: COLORS.textSecondary, marginBottom: wp('1.25%') },
  ...
  label: { fontSize: fontSize.sm, color: COLORS.text, marginBottom: wp('1.25%'), fontWeight: '500' },
  input: {
    borderWidth: 1, borderColor: COLORS.border, borderRadius: borderRadius.md,
    paddingHorizontal: spacing.md, paddingVertical: spacing.sm, fontSize: fontSize.md, backgroundColor: COLORS.white,
  },
  ...
  defaultBadge: {
    ...
    paddingHorizontal: wp('2%'), paddingVertical: wp('0.5%'), borderRadius: wp('1%'),
    fontSize: fontSize.sm, fontWeight: '500',
  },
  addressText: { fontSize: fontSize.sm, color: COLORS.textSecondary, marginBottom: wp('0.5%') },
  addressActions: { flexDirection: 'row', marginTop: spacing.sm, flexWrap: 'wrap' },
  actionButton: {
    paddingHorizontal: spacing.md, paddingVertical: wp('1.5%'), borderRadius: wp('1%'),
    borderWidth: 1, borderColor: COLORS.primary, marginRight: wp('2%'), marginBottom: wp('1.25%'),
  },
  actionButtonText: { color: COLORS.primary, fontSize: fontSize.sm, fontWeight: '500' },
