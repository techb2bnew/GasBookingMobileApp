          ...
          <View style={styles.modalContent}>
            ...
            <ScrollView style={styles.modalBody}>
              ...
              <View style={styles.priceItem}>
                ...
                <Text style={styles.priceText}>KSH950 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,250 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Haryana</Text>
                <Text style={styles.priceText}>KSH980 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,280 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Delhi</Text>
                <Text style={styles.priceText}>KSH1,050 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,350 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Uttar Pradesh</Text>
                <Text style={styles.priceText}>KSH920 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,220 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Maharashtra</Text>
                <Text style={styles.priceText}>KSH1,100 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,400 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Karnataka</Text>
                <Text style={styles.priceText}>KSH1,080 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,380 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Tamil Nadu</Text>
                <Text style={styles.priceText}>KSH1,020 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,320 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Gujarat</Text>
                <Text style={styles.priceText}>KSH1,000 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,300 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Rajasthan</Text>
                <Text style={styles.priceText}>KSH940 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,240 - Commercial</Text>
              </View>

              <View style={styles.priceItem}>
                <Text style={styles.stateName}>Madhya Pradesh</Text>
                <Text style={styles.priceText}>KSH930 - Domestic</Text>
                <Text style={styles.priceText}>KSH1,230 - Commercial</Text>
              </View>
